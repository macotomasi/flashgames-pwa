...
class FlashGamesDatabase extends Dexie {
  ...
  async getDeck(id: string): Promise<Deck | undefined> {
    ...
    return {
      ...dbDeck,
      createdAt: new Date(dbDeck.createdAt),
      updatedAt: new Date(dbDeck.updatedAt)
    }
  }
  ...
  private dbCardToCard(dbCard: DBCard): Card {
    return {
      ...
      lastReview: dbCard.lastReview ? new Date(dbCard.lastReview) : undefined,
      nextReview: dbCard.nextReview ? new Date(dbCard.nextReview) : undefined
    }
  }
